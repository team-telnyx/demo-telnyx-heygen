...
export async function POST(request) {
  try {
    ...
    const callId =
      requestData.CallSid ||
      requestData.call_control_id ||
      requestData.call_session_id;
...
<Response>
    <Record
        ...
        transcriptionCallback="${process.env.WEBHOOK_BASE_URL}/api/webhooks/telnyx/transcription"/>
</Response>`;
...
<Response>
    <Dial>
        <Sip statusCallback="${process.env.WEBHOOK_BASE_URL}/api/webhooks/telnyx/call-status" statusCallbackEvent="answered" statusCallbackMethod="POST">sip:gencredUJitZF1yIkFR3WhYAZObcamLFKSHdHZtjOEZ378x1T@sip.telnyx.com</Sip>
    </Dial>
</Response>`;
